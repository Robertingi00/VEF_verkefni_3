...
<body>
	...
	<section class="Frettir">
		<article class="dalkur_1">
			...
			<div class="mynd">
				<img src="/static/trump.jpg" width="434px" height="244px">
			</div>
			
		</article>
		<article class="dalkur_2">
			<h1 class="fyrirsogn">Helstu pésafréttir</h1>
			<ul>
				<li><a href="/frettir/0">Er Trump Trump?</a></li>
